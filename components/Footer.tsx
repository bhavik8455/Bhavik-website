  ...
  return (
    ...
    >
      <p className="text-center">
        © {new Date().getFullYear()} Bhavik Solanki. All rights reserved.
      </p>

      <div className="flex gap-4 items-center">
        <a
          href="https://github.com/bhavik8455"
          target="_blank"
        ...
        <a
          href="https://linkedin.com/in/bhavik8455"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-foreground transition-colors"
        >
        ...
        <a
          href="mailto:solankibhavik92@gmail.com"
          className="hover:text-foreground transition-colors"
        >
